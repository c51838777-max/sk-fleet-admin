...
const Dashboard = () => {
    ...
    return (
        <FleetDashboard stats={stats} yearlyStats={yearlyStats} isSupabaseReady={isSupabaseReady} trips={trips}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                ...
                <a href="https://sk-fleet-driver.vercel.app" className="btn btn-outline" style={{ textDecoration: 'none' }}>
